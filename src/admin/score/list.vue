  ...
  <div>
    <table class="table is-fullwidth">
      <thead>
        <tr>
          <th>Name</th>
          <th class="has-text-right" v-if="loggedIn"><i class="fa fa-cogs" aria-hidden="true"></i></th>
        </tr>
      </thead>
      <tbody>
    ...
    <button v-if="loggedIn" @click="open_form()" class="button is-primary">Add Score</button>
  </div>
</template>
